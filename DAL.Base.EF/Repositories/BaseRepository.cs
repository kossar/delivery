...
namespace DAL.Base.EF.Repositories
{
        ...
        where TDbContext : DbContext
    {
        ...
        protected IQueryable<TDomainEntity> CreateQuery(TKey? userId = default, bool noTracking = true)
        {
            ...
            if (userId != null && !userId.Equals(default) && typeof(IDomainAppUserId<TKey>)
                .IsAssignableFrom(typeof(TDomainEntity)))
            {
        ...
        {
            if (userId != null && typeof(IDomainAppUserId<TKey>).IsAssignableFrom(typeof(TDomainEntity)) && !((IDomainAppUserId<TKey>) entity).AppUserId.Equals(userId))
            {
